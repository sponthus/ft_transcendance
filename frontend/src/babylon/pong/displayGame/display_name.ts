...
export class DisplayName
{
    ...
    constructor(scene: Scene, namePlayer1: string, namePlayer2: string, meshPlayer1: AbstractMesh | null, meshPlayer2: AbstractMesh | null)
	{
		...
		this._plane1.position = new Vector3(-2, 1.8, -0.1); // décalé au-dessus de ton mesh
		this._plane1.rotation = new Vector3(0, Math.PI, 0); // 180° sur Y
		// GUI sur le plane
		...
		this._text1.color = "black";
		this._text1.fontSize = 70;
		...
		this._plane2.position = new Vector3(0, 0, -0.1); // décalé au-dessus de ton mesh
		...
		this._text2.color = "black";
		this._text2.fontSize = 96;
