...
export class HomePage extends BasePage {
	...
	private async InitDivs() {
		...
		this.Front = createDiv("front", "flex items-center justify-center rounded-xl shadow-2xl p-12 max-w-md w-full h-[20%] text-center");
		this.ButtonDiv = createDiv("Button", "flex flex-col items-center justify-center space-y-6 w-full");
	}
	
	private async createLogo() {
	this.LogoDiv = createDiv("logo", "relative grid place-items-center h-[80%] w-full animate-wiggle -my-[10px]");
	append(this.LogoDiv, [
