...
import { idUserSchema, slugSchema } from "../tools/checkFormat.js";
...
export default async function internalRoutes(fastify)
{
	...
	fastify.get("/internal-service/infos/:idUser", { preHandler: [fastify.verifyApiKey], schema: { params: idUserSchema } }, getUserInfosFromId);
}